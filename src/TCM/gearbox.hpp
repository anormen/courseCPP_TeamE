...
private:
    ...
    const int gearMapUpShift34[11] =   {1800, 2600, 3100, 3600, 4100, 4400, 4500, 4500, 4500, 4500, 5500 }; //rpm
    const int gearMapUpShift45[11] =   {1800, 2600, 3100, 3600, 4100, 4600, 4500, 4500, 4500, 4500, 5500 }; //rpm    
    int gearChangeHyst = 1000; // rpm
